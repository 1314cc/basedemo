package com.black.demo.aspect.logger;

import com.wanda.unicorn.icfwcore.gateway.aspect.BaseAspect;
...
public class LoggerAspect extends BaseAspect {
	 ...
	 * @throws Throwable
	 */
    @Around(value = "(execution(public * com.wanda.member.point.gateway.controller..*.*(..)) && (execution (@org.springframework.web.bind.annotation.RequestMapping * *(..))))")
