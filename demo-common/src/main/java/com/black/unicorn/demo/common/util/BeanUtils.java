...
import com.black.unicorn.demo.common.exception.BeanUtilsException;
...
public class BeanUtils {
    ...
    private static final String[] COPY_IGNORED_PROPERTIES = {"id", "createBy", "createTime", "updateTime"};
}
